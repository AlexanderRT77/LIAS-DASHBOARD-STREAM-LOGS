...
const MOCK_MODELS = {
  ...
  Gemini: {
    ...
    evaluations: { artificial_analysis_intelligence_index: 48 },
  ...
  Grok: {
    ...
    evaluations: { artificial_analysis_intelligence_index: 44 },
  ...
  Perplexity: {
    name: 'Perplexity',
    slug: 'sonar-pro',
    model_creator: { name: 'Perplexity AI', slug: 'perplexity' },
